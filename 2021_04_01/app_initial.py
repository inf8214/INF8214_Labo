...
def listeImages():
    # Lire d'abord le fichier json de la liste des images et stocker dans la variable 'images'
    filepath = './static/json/listeImages.json'
    with open(filepath, 'r') as f:
        data = f.read()
    images = json.loads(data)
    # Stocker la valeur de l'argument 'droits' de la requête dans une variable (après conversion en booléen)
    droits = True if request.args.get('droits') == "True" else False
    # retouner un template, avec passation des variables 'images' et 'droits'
